...
${OBJECTDIR}/sellers_package/high_seller.o: sellers_package/high_seller.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sellers_package/high_seller.o sellers_package/high_seller.cpp

${OBJECTDIR}/sellers_package/low_seller.o: sellers_package/low_seller.cpp
	${MKDIR} -p ${OBJECTDIR}/sellers_package
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sellers_package/low_seller.o sellers_package/low_seller.cpp

${OBJECTDIR}/sellers_package/mid_seller.o: sellers_package/mid_seller.cpp
	${MKDIR} -p ${OBJECTDIR}/sellers_package
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sellers_package/mid_seller.o sellers_package/mid_seller.cpp

${OBJECTDIR}/sellers_package/seller.o: sellers_package/seller.cpp
	${MKDIR} -p ${OBJECTDIR}/sellers_package
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sellers_package/seller.o sellers_package/seller.cpp
